...
SwapChain::~SwapChain()
{
    ...
    {
        vkDestroySemaphore(d, imageAvailableSemaphore[i], nullptr);
        vkDestroyFence(d, inFlightFence[i], nullptr);
    }
    ...
    {
        vkDestroyImageView(d, imageView, nullptr);
    }
    for (int i = 0; i < depthImages.size(); i++)
    {
        vkDestroyImageView(d, depthImageViews[i], nullptr);
        vkDestroyImage(d, depthImages[i], nullptr);
        vkFreeMemory(d, depthImageMemorys[i], nullptr);
    }
...
void SwapChain::createDepthResources()
{
    ...
    for (int i = 0; i < depthImages.size(); i++)
    {
        createImage(swapChainExtent.width, swapChainExtent.height, depthFormat,
                    ...
                    VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImages[i], depthImageMemorys[i]);
